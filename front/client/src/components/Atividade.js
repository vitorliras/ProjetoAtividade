      ...
      <Card.Body>
        <div className='d-flex justify-content-between me-2'>
          ...
          <h6 style={{ fontSize: '15px' }} >Prioridade:
            <span className='prioridade ms-1'>
              <i className={"me-1 fa-regular fa-face-" + prioridadeIcons(props.atv.prioridade)}></i>{prioridadeLabel(props.atv.prioridade)}
            </span>
          </h6>
        </div>
        <Card.Text>
        ...
        <div className='d-flex justify-content-end me-2 border-top pt-2 m-0'>
          <button
            ...
            onClick={() => props.getAtividade(props.atv.id)}>
